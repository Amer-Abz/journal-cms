...
import Image from "next/image"; // Keep existing imports if needed
import LanguageSwitcher from '@/components/LanguageSwitcher'; // We will create this component
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <ol className="list-inside list-decimal text-sm/6 text-center sm:text-left">
          <li className="mb-2 tracking-[-.01em]">
            Get started by editing relevant files.
          </li>
